  ...
  if (constraints.builder && typeof nuxt.options.builder === "string") {
    ...
    if (currentBuilder in constraints.builder) {
      ...
      if (constraint === false) {
        ...
        for (const parent of [nuxt.options.rootDir, nuxt.options.workspaceDir, "file:///Users/talk/Documents/GitHub/adis/node_modules/nuxt-site-config/node_modules/@nuxt/kit/dist/index.mjs"]) {
...
const distDirURL = new URL(".", "file:///Users/talk/Documents/GitHub/adis/node_modules/nuxt-site-config/node_modules/@nuxt/kit/dist/index.mjs");
...
function tryResolveModule(id, url = "file:///Users/talk/Documents/GitHub/adis/node_modules/nuxt-site-config/node_modules/@nuxt/kit/dist/index.mjs") {
...
function resolveModule(id, options) {
  return (0, _exsolve.resolveModulePath)(id, {
    from: options?.url ?? options?.paths ?? ["file:///Users/talk/Documents/GitHub/adis/node_modules/nuxt-site-config/node_modules/@nuxt/kit/dist/index.mjs"],
...
function requireModule(id, opts) {
  ...
  const resolvedPath = resolveModule(id, opts);
  const jiti = (0, _jiti.createJiti)("file:///Users/talk/Documents/GitHub/adis/node_modules/nuxt-site-config/node_modules/@nuxt/kit/dist/index.mjs", {
...
async function resolveFiles(path, pattern, opts = {}) {
  const files = [];
  for (const file of await (0, _tinyglobby.glob)(pattern, { cwd: path, followSymbolicLinks: opts.followSymbolicLinks ?? true })) {
...
async function loadNuxtConfig(opts) {
  const localLayers = (await (0, _tinyglobby.glob)("layers/*", { onlyDirectories: true, cwd: opts.cwd || process.cwd() })).map((d) => d.endsWith("/") ? d.substring(0, d.length - 1) : d);
...
async function _generateTypes(nuxt) {
  ...
  relativeWithDot(nuxt.options.buildDir, (0, _pathe.resolve)(nuxt.options.rootDir, ".data"))]
  );
