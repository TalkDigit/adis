import { getCurrentInstance, hasInjectionContext, inject, computed, toValue, reactive, shallowRef, ref, watchEffect, watch, toRef, onServerPrefetch, effectScope, isRef, isReactive, toRaw, unref, getCurrentScope, onScopeDispose, nextTick, toRefs, markRaw, version, defineComponent, provide, createElementBlock, defineAsyncComponent, h, shallowReactive, Suspense, Fragment, Transition, createApp, createVNode, Text, onErrorCaptured, resolveDynamicComponent, isReadonly, isShallow, mergeProps, withAsyncContext, withCtx, useSSRContext } from 'vue';
import { o as defu, i as createError$1, E as hash, F as sanitizeStatusCode, $ as $fetch, G as createHooks, H as toRouteMatcher, I as createRouter$1, J as destr, K as klona, L as parse$1, M as getRequestHeader, N as isEqual$1, O as setCookie, P as getCookie, Q as deleteCookie, R as getRequestHeaders } from '../runtime.mjs';
...
function stringifyParsedURL(parsed) {
  ...
  return proto + auth + host + pathname + search2 + hash2;
}
...
const _routes = [
  {
    name: "aboutUs",
    path: "/aboutUs",
    component: () => import('./aboutUs-CEinyHwH.mjs').then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DlBcSZbf.mjs').then((m) => m.default || m)
  },
  {
    name: "exampleModulePage",
    path: "/exampleModulePage",
    component: () => import('./exampleModulePage-CdEZ7x_x.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DyOP-fmx.mjs').then((m) => m.default || m)
  },
  {
    name: "page",
    path: "/page",
    component: () => import('./page-Bm9cDEDN.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
  ...
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-DGSKYaO8.mjs').then((m) => m.default || m)
  },
  {
    name: void 0 ,
    path: "/sitemap.xml",
...
const home = () => import('./index-DyOP-fmx.mjs').then((r) => r.default || r), page = () => import('./page-Bm9cDEDN.mjs').then((r) => r.default || r), search = () => import('./search-DGSKYaO8.mjs').then((r) => r.default || r);
const routerOptions1 = {
  ...
  routes: (_routes2) => [
    ...
    },
    {
      name: "aboutUs",
      path: "/aboutUs",
      component: () => import('./aboutUs-CEinyHwH.mjs')
    },
    {
      name: "projects",
      path: "/projects",
    ...
    },
    {
      name: "contact",
      path: "/contact",
      component: () => import('./contact-DlBcSZbf.mjs')
    }
  ]
};
...
const active_45lang_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
  const nuxtApp = useNuxtApp();
  if (to.meta.lang != void 0) {
...
const LazyCustomSlider = defineAsyncComponent(() => import('./CustomSlider-D8TjU8nz.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsTarget = defineAsyncComponent(() => import('./Target-Br3Gz6np.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsAdress = defineAsyncComponent(() => import('./adress-BdVNJYPc.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsEmaill = defineAsyncComponent(() => import('./emaill-cLzg-RLT.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsFacebook = defineAsyncComponent(() => import('./facebook-B3kJY8f3.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsFax = defineAsyncComponent(() => import('./fax-B2r_oNNv.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsFlag = defineAsyncComponent(() => import('./flag-CjcDd6xr.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsGray = defineAsyncComponent(() => import('./gray-ByAem5-1.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsGreenok = defineAsyncComponent(() => import('./greenok-BVp7BJdg.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsHeadset = defineAsyncComponent(() => import('./headset-D27Ix1sv.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsInfo = defineAsyncComponent(() => import('./info-DzkEbfEJ.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsInstagram = defineAsyncComponent(() => import('./instagram-zuZzNgzb.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsLighting = defineAsyncComponent(() => import('./lighting-DR9ugpa0.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsLink = defineAsyncComponent(() => import('./link-lKGxczAW.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsLinkedin = defineAsyncComponent(() => import('./linkedin-DopAoBJC.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsMail = defineAsyncComponent(() => import('./mail-s6sRdTD0.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsPhonee = defineAsyncComponent(() => import('./phonee-CZHSZQHa.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsRight = defineAsyncComponent(() => import('./right-BiVHQQ1A.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsRightold = defineAsyncComponent(() => import('./rightold-CE7bTiP4.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsRighttwo = defineAsyncComponent(() => import('./righttwo-YDkk0B_8.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsSearch = defineAsyncComponent(() => import('./search-C_diyyA6.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsSolar = defineAsyncComponent(() => import('./solar-85BdntU1.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsTwitter = defineAsyncComponent(() => import('./twitter-CJGovR8_.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsWhiteIcon = defineAsyncComponent(() => import('./whiteIcon-Becw2rwF.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsWhiteright = defineAsyncComponent(() => import('./whiteright-D5io6ihh.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsWind = defineAsyncComponent(() => import('./wind-DZAN_xFS.mjs').then((r) => r["default"] || r.default || r));
const LazyIconsYoutube = defineAsyncComponent(() => import('./youtube-C5IeTLvS.mjs').then((r) => r["default"] || r.default || r));
const LazyLayoutsFooter = defineAsyncComponent(() => import('./Footer-Ch46idXr.mjs').then((r) => r["default"] || r.default || r));
const LazyLayoutsHeader = defineAsyncComponent(() => import('./Header-CaUENOkz.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleAbout = defineAsyncComponent(() => import('./About-CaeuryrI.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleAboutFuture = defineAsyncComponent(() => import('./AboutFuture-BGxPUrwe.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleCardSlider = defineAsyncComponent(() => import('./CardSlider-A_KAJyOt.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleContact = defineAsyncComponent(() => import('./Contact-IGFSAec4.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleContainer = defineAsyncComponent(() => import('./Container-BoUm00_a.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeEss = defineAsyncComponent(() => import('./HomeEss-BIMN-dud.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeLinkBanner = defineAsyncComponent(() => import('./HomeLinkBanner-vtbseajP.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeMore = defineAsyncComponent(() => import('./HomeMore-PnXGSNTQ.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeMultiCard = defineAsyncComponent(() => import('./HomeMultiCard-BZ5XCUcv.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeSlider = defineAsyncComponent(() => import('./HomeSlider-bpOVCwmo.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeSocial = defineAsyncComponent(() => import('./HomeSocial-YJGX9EkG.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeTab = defineAsyncComponent(() => import('./HomeTab-DGMXXpD0.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleHomeTabSection = defineAsyncComponent(() => import('./HomeTabSection-C4FNBKoz.mjs').then((r) => r["default"] || r.default || r));
...
const LazyModuleVisionMission = defineAsyncComponent(() => import('./VisionMission-Cuoo378u.mjs').then((r) => r["default"] || r.default || r));
const LazyModuleExampleListModule = defineAsyncComponent(() => import('./exampleListModule-bLwBOcmP.mjs').then((r) => r["default"] || r.default || r));
...
const lazyGlobalComponents = [
  ...
  ["IconsAdress", LazyIconsAdress],
  ["IconsEmaill", LazyIconsEmaill],
  ["IconsFacebook", LazyIconsFacebook],
  ["IconsFax", LazyIconsFax],
  ["IconsFlag", LazyIconsFlag],
  ["IconsGray", LazyIconsGray],
  ["IconsGreenok", LazyIconsGreenok],
  ["IconsHeadset", LazyIconsHeadset],
  ["IconsInfo", LazyIconsInfo],
  ["IconsInstagram", LazyIconsInstagram],
  ["IconsLighting", LazyIconsLighting],
  ["IconsLink", LazyIconsLink],
  ["IconsLinkedin", LazyIconsLinkedin],
  ["IconsMail", LazyIconsMail],
  ["IconsPhonee", LazyIconsPhonee],
  ["IconsRight", LazyIconsRight],
  ["IconsRightold", LazyIconsRightold],
  ["IconsRighttwo", LazyIconsRighttwo],
  ["IconsSearch", LazyIconsSearch],
  ["IconsSolar", LazyIconsSolar],
  ["IconsTwitter", LazyIconsTwitter],
  ["IconsWhiteIcon", LazyIconsWhiteIcon],
  ["IconsWhiteright", LazyIconsWhiteright],
  ["IconsWind", LazyIconsWind],
  ["IconsYoutube", LazyIconsYoutube],
  ["LayoutsFooter", LazyLayoutsFooter],
  ["LayoutsHeader", LazyLayoutsHeader],
  ["ModuleAbout", LazyModuleAbout],
  ["ModuleAboutFuture", LazyModuleAboutFuture],
  ["ModuleCardSlider", LazyModuleCardSlider],
  ["ModuleContact", LazyModuleContact],
  ["ModuleContainer", LazyModuleContainer],
  ["ModuleHomeEss", LazyModuleHomeEss],
  ["ModuleHomeLinkBanner", LazyModuleHomeLinkBanner],
  ["ModuleHomeMore", LazyModuleHomeMore],
  ["ModuleHomeMultiCard", LazyModuleHomeMultiCard],
  ["ModuleHomeSlider", LazyModuleHomeSlider],
  ["ModuleHomeSocial", LazyModuleHomeSocial],
  ["ModuleHomeTab", LazyModuleHomeTab],
  ["ModuleHomeTabSection", LazyModuleHomeTabSection],
  ["ModuleHomeTabold", LazyModuleHomeTabold],
  ["ModuleKvkk", LazyModuleKvkk],
  ["ModuleKvkkMetin", LazyModuleKvkkMetin],
  ["ModuleMapsSection", LazyModuleMapsSection],
  ["ModuleMapss", LazyModuleMapss],
  ["ModuleProjects", LazyModuleProjects],
  ["ModuleSocialSlider", LazyModuleSocialSlider],
  ["ModuleVisionMission", LazyModuleVisionMission],
  ["ModuleExampleListModule", LazyModuleExampleListModule],
  ["ModuleExampleModule", LazyModuleExampleModule],
  ["ModuleForm", LazyModuleForm],
  ["ModuleLang", LazyModuleLang],
  ["ModuleMapsdark", LazyModuleMapsdark]
];
...
const vueI18nConfigs = [
  () => import(
    './i18n.config-BZyG0txD.mjs'
    /* webpackChunkName: "__lang_i18n_config_ts_980b4b1d" */
  )
];
...
function resolveRoute(common, route, locale) {
  ...
  if (isString(route)) {
    if (route[0] === "/") {
      const { pathname: path, search: search2, hash: hash2 } = parsePath(route);
...
const switch_locale_path_ssr_8BKffvaEi5 = /* @__PURE__ */ defineNuxtPlugin({
...
const layouts = {
  default: () => import('./default-BbdGixYO.mjs').then((m) => m.default || m)
};
...
function useCustomFetch(url, options = {}) {
  ...
  return useFetch(url, params, "$sC22i8rhLA");
}
const useSettings = defineStore("Settings", {
  ...
  actions: {
    async FetchSettings() {
      await useCustomFetch("settings").then((response) => {
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const SettingsStore = useSettings(), { locale } = useI18n();
    useHead({
      htmlAttrs: {
        lang: locale.value
      },
      titleTemplate: (titleChunk) => {
        return titleChunk ? `${titleChunk} ${SettingsStore.settings["site-ayarlari"][1].value[locale.value] ?? SettingsStore.settings["site-ayarlari"][1].value.tr}` : SettingsStore.settings["site-ayarlari"][0].value[locale.value] ?? SettingsStore.settings["site-ayarlari"][0].value.tr;
      },
      meta: [
    ...
    [__temp, __restore] = withAsyncContext(() => callOnce(SettingsStore.FetchSettings, "$E3KxD8SGyR")), await __temp, __restore();
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CbCJW2nM.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CIIgiiq0.mjs').then((r) => r.default || r));
...
export { useCustomFetch as a, useI18n as b, callOnce as c, defineStore as d, entry$1 as default, useRoute as e, useRouter as f, useSeoMeta as g, useNuxtApp as h, createError as i, hasProtocol as j, joinURL as k, useRuntimeConfig as l, withoutTrailingSlash as m, navigateTo as n, nuxtLinkDefaults as o, parseQuery as p, resolveRouteObject as r, useHead as u, withTrailingSlash as w };
